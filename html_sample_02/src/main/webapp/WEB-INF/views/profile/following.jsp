	 ...
	 <div class="middlecontainer" >
		<section class="headsec">
		   ...
		   <section class="tweets">
               <div class="heading">
                   <div class="heading_content" onclick="location.href='/profile/follower?id=${udto.user_id}'">팔로워</div>
                   <div class="heading_like" onclick="location.href='/profile/following?id=${udto.user_id}'">팔로잉<div class="content_underbar"></div></div>
               </div>
           </section>
           
		   <section>
		   <c:forEach items="${following}" var="Udto" varStatus="stat">
