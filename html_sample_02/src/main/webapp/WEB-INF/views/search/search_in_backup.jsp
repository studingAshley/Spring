...
<body>
	...
	<!--검색창 -->
		<div class="aside_input">
			...
			<form action="search_in" id="search_frm" method="post">
	...
	<!--카테고리-->
		<div class="category_menu" >
			<a href="search_in"><div class="search_in" >인기<div class="underscore"></div></div></a>
	...
	<!-- <div class="post">
	  ...
	  <div class="post" id="${Pdto.post_id}" style="position:relative;">
            ...
            <div class="post_body">
                ...
                <div class="post_footer">
                    ...
                    <span class="material-icons ms_icons favorite like">favorite_border</span><h3>${Pdto.plike}</h3>
