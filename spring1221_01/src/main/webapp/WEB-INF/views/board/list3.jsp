...
<html>
	...
	<body>
		...
		<c:forEach items="${list}" var="memBDto">

			<tr>
			  <td>${memBDto.mdto.id}</td>
			  <td>${memBDto.mdto.pw}</td>
			  <td>${memBDto.mdto.name}</td>
			  <td>${memBDto.mdto.phone}</td>
			  <td>${memBDto.mdto.gender}</td>
			  <td>${memBDto.mdto.hobby}</td>
			  <td>${memBDto.bdto.bno}</td>
			  <td>${memBDto.bdto.btitle}</td>
			  <td>${memBDto.bdto.id}</td>
			  <td>${memBDto.bdto.bdate}</td>
			</tr>
