		...
		<div id="outbox">		
			...
			$(function(){
				...
				$("#idsearchBtn").click(function(){
					...
					console.log(email);
					$.ajax({
					    url:"/member/idMailCheck",
					    data: {"name":name,"email":email},                // HTTP 요청과 함께 서버로 보낼 데이터
					    ...
					    success:function(data)
					    {
					    	...
					    	if(data.result=="성공")
					    	{
					    		location.href="/member/id?id="+data.tempId+"&email="+email;
					    	}
					    	else
					    	{
			...
			<div id="contents">
				<div id="member">
					...
					<div class="informbox">
						<div class="inform">
							<ul>
								<li><input type="text" id="nameType"class="nameType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='nameType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
								<li><input type="text" id="emailType" class="emailType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='emailType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							</ul>

							<div class="btn"><a  class="gbtn" id="idsearchBtn">아이디 찾기</a></div>
						</div>
					</div>
