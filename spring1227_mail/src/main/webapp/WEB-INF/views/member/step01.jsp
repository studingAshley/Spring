                    	  ...
                    	  $(".nbtnMini2").click(function(){
                    		  ...
                    		  $.ajax({
                    			  ...
                    			  success:function(data){
                    				if(data.result=="사용가능")
                   					 {
	                   				 	alert("요청하신 메일로 인증코드가 전송되었습니다.");
                  					 }
                    				else
                    				{
                    					alert("사용불가능한 이메일입니다. 다른 메일을 입력해주세요.");
                    				}
                    				console.log(data);
                    			  },
                    			  error:function(){
					...
					<div class="btnArea">
						<div class="bCenter2">
							<ul>
								...
								<li class="w201"></li>
								<li class="r10"><input type="text" id="userCode" class="w200" /></li>
								<li><a id="codeCheck" class="sbtnMini2">비밀번호인증</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
