...
<section>
    <h1>NOTICE</h1>
	<form action="bDelete" id="bFrm" method="post" name="bFrm">
	    ...
	    <script>
	    	...
	    	$(function(){
	    		...
	    		$(".delbtn").click(function(){
	    			...
	    			{
	    				$("#bFrm").attr("action","bDelete").submit();	//bDelete
	    			}
	    		});
	    		$(".breply").click(function(){

	    			$("#bFrm").attr("action","bReply").submit();	//bDelete
