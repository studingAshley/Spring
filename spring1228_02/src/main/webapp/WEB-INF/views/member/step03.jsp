						...
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" class="w134" id="name"/></td>
								</tr>
								<tr>
									<th scope="row"><span>아이디 *</span></th>
									<td>
										<ul class="pta">
											<li class="r10"><input type="text" class="w134" id="myId"/></li>
											<li><a class="nbtnMini" id="duplCheck" style="cursor: pointer;">중복확인</a></li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="password" class="w134" id="pw"/></li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="password" class="w134" id="pwCheck" /></li>
											<li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li>&nbsp;<span class="valign">-</span>&nbsp;</li>
											<li><input type="text" class="w74" maxlength="4" id="phone2" /> <span class="valign">-</span>&nbsp;</li>
											<li class="r10"><input type="text" class="w74" maxlength="4" id="phone3"/></li>
