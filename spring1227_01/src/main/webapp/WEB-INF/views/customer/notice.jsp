			...
			<div id="contents">
				<div id="customer">
					...
					<div class="btnAreaList">
						...
						<a href="notice?page=${page-1}" class="n"><img src="../images/btn/btn_pre2.gif" alt="처음으로"/></a><a href="notice?page=1" class="pre"><img src="../images/btn/btn_pre1.gif" alt="앞페이지로"/></a>
						
						<c:forEach begin="${pageStart}" end="${pageStart+4}" var="i">							
							<c:if test="${page==i}">
								<strong>${i}</strong>
							</c:if>
							<c:if test="${page!=i}">
						...
						<a href="notice?page=${page+1}" class="next"><img src="../images/btn/btn_next1.gif" alt="뒤페이지로"/></a><a href="notice?page=${maxPage}" class="n"><img src="../images/btn/btn_next2.gif" alt="마지막페이지로"/></a>
					...
					<script>
						$(function(){
							$(".searchBtn").click(function(){
								...
								let searchVal = $("#searchVal option:selected").val();
								console.log("s1 : "+searchWord);
								console.log("s2 : "+searchVal);
								...
								location.href="notice?page=${page}&word="+searchWord+"&type="+searchVal;
							})
						})
					</script>
					...
					<div class="searchWrap">
						<div class="search">
							<ul>
								...
								<li class="web"><a style="cursor: pointer;" class="searchBtn"><img src="../images/btn/btn_search.gif" alt="검색" /></a></li>
